...
import com.arlania.world.content.npckills.AccountsMade;
import com.arlania.world.content.npckills.NpcKills;
import com.arlania.world.content.npckills.TotalLogins;
import com.arlania.world.content.npckills.TotalSold;
...
public class PlayerPanel {
	...
	public static void refreshPanel(Player player) {
		...
		int counter = 39159;
		player.getPacketSender().sendString(counter++, "@cya@ Click Me!");
		player.getPacketSender().sendString(counter++, LINE_START.replace("", "") + "@or1@Contact Staff!");
		player.getPacketSender().sendString(counter++, LINE_START.replace("", "") + "@or1@My Panel");
		...
		player.getPacketSender().sendString(counter++, "@cya@ Current Events");
		...
		player.getPacketSender().sendString(counter++, "@cya@ Account Information");
		...
		player.getPacketSender().sendString(counter++, "@cya@ My Points");
...
//		player.getPacketSender().sendString(counter++, LINE_START + "@or1@Arena Losses:@yel@ "+player.getPointsHandler().getLoyaltyPoints());
		...
		player.getPacketSender().sendString(counter++, "@cya@ Slayer Information");
		...
		player.getPacketSender().sendString(counter++, "@cya@Server Statistics");
		player.getPacketSender().sendString(counter++,
				LINE_START + "@or1@NPC Kills: @gre@"+NpcKills.getTotalNpcsKilled());
		player.getPacketSender().sendString(counter++,
				LINE_START  + "@or1@Accounts Made: @gre@"+AccountsMade.getTotalAccountsMade());
		
		player.getPacketSender().sendString(counter++,
				LINE_START  + "@or1@Total Logins: @gre@"+TotalLogins.getTotalLogins());
		player.getPacketSender().sendString(counter++,
				LINE_START  + "@or1@Items Sold: @gre@"+TotalSold.getTotalLogins());
		player.getPacketSender().sendString(counter++, "");
		player.getPacketSender().sendString(counter++, "");
		player.getPacketSender().sendString(counter++, "");
		player.getPacketSender().sendString(counter++, "");
