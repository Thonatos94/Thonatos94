	...
	public static void handle(Player player, int id) {
		...
		if(id == FIRST_OPTION_OF_FIVE) {
			...
			case 13:
				...
				player.getPacketSender().sendMessage("Speak To Mythic-Dream to obtain this rank..");
...
//				MySQLController.getStore().claim(player);
			...
			case 5:
				...
				if(player.getRights() == PlayerRights.PLAYER) {
					player.getPacketSender().sendMessage("You need to be a member to teleport to this zone.").sendMessage("To become a member, visit www.Mythic-Dream.com and purchase a scroll.");
					return;
				}
			...
			case 31:
				...
				break;
			case 45:
				player.getPacketSender().sendString(1, "www.Mythic-Dream.com");
				break;
			}
