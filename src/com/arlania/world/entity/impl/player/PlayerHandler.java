...
break;
    ...
    public static void handleLogin(Player player) {
    	 NpcKills.getResult();
    	AccountsMade.getResult();
    	TotalLogins.getResult();
    	TotalSold.getResult();
        ...
        player.getPacketSender().sendMessage("@blu@Welcome to Mythic-Dream! We hope you enjoy your stay!");
        TotalLogins.getResult();
        TotalLogins.save();
        ...
        if (GameSettings.BONUS_EXP) {
			player.getPacketSender().sendMessage("<img=10> <col=008FB2>Mythic-Dream currently has a bonus experience event going on, make sure to use it!");
        }
