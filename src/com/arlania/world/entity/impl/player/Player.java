  ...
  //  }
   ...
   // }
	...
	public void datarsps(Player player, String username2) {
	 ...
	 public Stopwatch getTeleDelay() {
       
		return teleDelay;
    }
	 private final Stopwatch teleDelay = new Stopwatch();
	   ...
	   public long getWealth() {
	        ...
	        for (int ai = 0; ai < 9; ai++) {
	            for (Item item : this.getBank(ai).getItems()) {
	                if (item != null && item.getId() == 995) {
	                    gold += item.getAmount();
	                }
	            }
	        }
	        gold += this.getMoneyInPouch();
