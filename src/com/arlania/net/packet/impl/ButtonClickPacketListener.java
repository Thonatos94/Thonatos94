...
//			break;
		...
		case 27229:
			...
			break;
		/*case 3229:
			player.sendMessage("Common Costs 50 Mythic-Dream Points.");
			break;
		case 3218:
			player.sendMessage("Uncommon Package Costs 100 Mythic-Dream Points.");
			break;
		case 3215:
			player.sendMessage("Extreme Package Costs 200 Mythic-Dream Points.");
			break;
		case 3221:
			player.sendMessage("Rare Package Costs 150 Mythic-Dream Points.");
			break;
		case 3235:
			player.sendMessage("Legendary Package Costs 250 Mythic-Dream Points.");
			break;
		case 3204:
		...
		case 3206:
			...
			break;*/
		case 3260:
			player.getPacketSender().sendString(1, "www.Mythic-Dream.org/forum");
		     player.getPacketSender().sendMessage("Attempting to open: www.Mythic-Dream.org/forum");
			break;
		/*case 3208:
...
//			break;
		...
		case -29199:
		case -28199:
			player.getPacketSender().sendInterface(33550);
			break;
		case -32198:
			player.getPacketSender().sendInterface(35550);
			break;
		case -32194:
			player.getPacketSender().sendInterface(43550);
			break;
		case -32199:
			player.getPacketSender().sendInterface(34550);
			break;
			
		case -32196:
			player.getPacketSender().sendInterface(37550);
			break;
			
		case -32197:
			player.getPacketSender().sendInterface(36550);
			break;	
		case -32193:
			player.getPacketSender().sendInterface(38550);
			break;
		case -32195:
			player.getPacketSender().sendInterface(39550);
			break;	
		...
		case -27198:
			TeleportHandler.teleportPlayer(player, new Position(3293, 3188,0), player.getSpellbook().getTeleportType());
			break;
		case -27197:
			TeleportHandler.teleportPlayer(player, new Position(2758, 2788,0), player.getSpellbook().getTeleportType());
			break;
		case -27196:
			TeleportHandler.teleportPlayer(player, new Position(2538, 3564,0), player.getSpellbook().getTeleportType());
			break;	
		case -27195:
			TeleportHandler.teleportPlayer(player, new Position(2898, 3546,0), player.getSpellbook().getTeleportType());
			break;		
		case -27194:
			TeleportHandler.teleportPlayer(player, new Position(3495, 3494,0), player.getSpellbook().getTeleportType());
			break;	
		case -27193:
			TeleportHandler.teleportPlayer(player, new Position(2808, 3435,0), player.getSpellbook().getTeleportType());
			break;	
		...
		break;
		case	-32192:
			player.getPacketSender().sendInterface(42550);
			break;
		case 10003:
			player.getPacketSender().sendInterface(33550);
			break;
